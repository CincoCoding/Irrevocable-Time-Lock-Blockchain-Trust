...
#waitingPeriod_ABI = web3.eth.abi.encode_uint(waitingPeriod)

#paymentPerPayoutPeriod_ABI =web3.eth.abi.encode_uint(paymentPerPayoutPeriod)
...
if st.button("Deploy Contract"):
    ...
    # Constructor
    transaction = timeLock_contract.constructor(_trustee_ABI, _beneficiary1_ABI, _beneficiary2_ABI, waitingPeriod, paymentPerPayoutPeriod).buildTransaction({"gasPrice": w3.eth.gas_price,"chainId": 1337, "from": _trustee,"nonce": nonce})
